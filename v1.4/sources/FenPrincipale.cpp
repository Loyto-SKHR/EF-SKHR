...
FenPrincipale::FenPrincipale()
{
    ...
    connect(onglets, SIGNAL(tabCloseRequested(int)), this, SLOT(fermerOngletSlot(int)));
...
//--fermerOnglet (SLOT):
void FenPrincipale::fermerOngletSlot(int index)
{
...
void FenPrincipale::ouvrirFichierF()
{
    ...
    QString fichier = QFileDialog::getOpenFileName(this, "Ouvrir un fichier", QString(), "tous les fichiers (*.*);; Texte (*.txt);; web (*.htm* *.css *.php *.js);; python (*.py);; C/C++ (*.c *.cpp *.h)");
